...
public class UpdateTypeUsecase extends BaseUseCase<BaseResponse> {
    private static final String TAG = UpdateTypeUsecase.class.getSimpleName();
    private final OtherRepository remoteRepository;

    public UpdateTypeUsecase(OtherRepository remoteRepository) {
    ...
    protected Observable<BaseResponse> buildUseCaseObservable() {
        ...
        return remoteRepository.updateTypeStock(Constants.APP_CODE,data);
    }
