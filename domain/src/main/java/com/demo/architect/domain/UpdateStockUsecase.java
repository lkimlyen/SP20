...
public class UpdateStockUsecase extends BaseUseCase<BaseResponse> {
    private static final String TAG = UpdateStockUsecase.class.getSimpleName();
    private final OtherRepository remoteRepository;

    public UpdateStockUsecase(OtherRepository remoteRepository) {
    ...
    protected Observable<BaseResponse> buildUseCaseObservable() {
        ...
        return remoteRepository.updateStock(Constants.APP_CODE,data);
    }
