...
public class AddCustomerGiftMegaUsecase extends BaseUseCase<BaseResponse> {
    private static final String TAG = AddCustomerGiftMegaUsecase.class.getSimpleName();
    private final GiftRepository remoteRepository;

    public AddCustomerGiftMegaUsecase(GiftRepository remoteRepository) {
    ...
    protected Observable<BaseResponse> buildUseCaseObservable() {
        ...
        return remoteRepository.addCustomerGiftMega(Constants.APP_CODE, data);
