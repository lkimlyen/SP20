...
public class AddWarehouseRequirementSetUsecase extends BaseUseCase<BaseResponse<Integer>> {
    private static final String TAG = AddWarehouseRequirementSetUsecase.class.getSimpleName();
    private final GiftRepository remoteRepository;

    public AddWarehouseRequirementSetUsecase(GiftRepository remoteRepository) {
    ...
    protected Observable<BaseResponse<Integer>> buildUseCaseObservable() {
        ...
        return remoteRepository.addWarehouseRequirementSet(Constants.APP_CODE, data);
