...
public class AddCustomerProductUsecase extends BaseUseCase<BaseResponse> {
    private static final String TAG = AddCustomerProductUsecase.class.getSimpleName();
    private final GiftRepository remoteRepository;

    public AddCustomerProductUsecase(GiftRepository remoteRepository) {
    ...
    protected Observable<BaseResponse> buildUseCaseObservable() {
        ...
        return remoteRepository.addCustomerProduct(Constants.APP_CODE, data);
