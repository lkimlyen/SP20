...
public class AddPOSMUsecase extends BaseUseCase<BaseResponse>  {
    private static final String TAG = AddPOSMUsecase.class.getSimpleName();
    private final OtherRepository remoteRepository;

    public AddPOSMUsecase(OtherRepository remoteRepository) {
    ...
    protected Observable<BaseResponse>  buildUseCaseObservable() {
        ...
        return remoteRepository.addPOSM(Constants.APP_CODE,data);
    }
