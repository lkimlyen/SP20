...
public class UpdateCurrentGiftUsecase extends BaseUseCase<BaseResponse> {
    private static final String TAG = UpdateCurrentGiftUsecase.class.getSimpleName();
    private final GiftRepository remoteRepository;

    public UpdateCurrentGiftUsecase(GiftRepository remoteRepository) {
    ...
    protected Observable<BaseResponse> buildUseCaseObservable() {
        ...
        return remoteRepository.updateCurrentGift(Constants.APP_CODE, data);
