...
public interface AccountApiInterface {
    ...
    @FormUrlEncoded
    @POST("https://sp.imark.com.vn/ws/api/loginWS")
    ...
    @FormUrlEncoded
    @POST("https://sp.imark.com.vn/WS/api/ChangePassWS")
    ...
    @FormUrlEncoded
    @POST("https://sp.imark.com.vn/ws/api/AddAttendanceTrackingWS")
    ...
    @FormUrlEncoded
    @POST("https://sp.imark.com.vn/WS/api/AddAttendanceTrackingImageWS")
    ...
    @FormUrlEncoded
    @POST("https://sp.imark.com.vn/WS/api/LogOutWS")
